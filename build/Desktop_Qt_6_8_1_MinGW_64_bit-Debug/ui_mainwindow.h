...
public:
    ...
    QPushButton *EtatDrone;
    QTextEdit *EtatDemarrage;
    QMenuBar *menubar;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        EtatDrone = new QPushButton(centralwidget);
        EtatDrone->setObjectName("EtatDrone");
        EtatDrone->setGeometry(QRect(270, 20, 151, 41));
        EtatDrone->setToolTipDuration(8);
        EtatDrone->setStyleSheet(QString::fromUtf8("color: rgb(0,0, 0);"));
        EtatDemarrage = new QTextEdit(centralwidget);
        EtatDemarrage->setObjectName("EtatDemarrage");
        EtatDemarrage->setGeometry(QRect(280, 70, 101, 31));
        EtatDemarrage->setReadOnly(true);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        EtatDrone->setText(QCoreApplication::translate("MainWindow", "D\303\251marrage du drone", nullptr));
    } // retranslateUi
